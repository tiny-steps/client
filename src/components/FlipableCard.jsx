...
function FlippableCard({ frontContent, backContent }) {
 ...
 <Card className="bg-white/90 backdrop-blur-lg border border-white/50 w-full h-full flex items-center justify-center md:justify-between flex-row p-6 md:p-8 shadow-xl">
 {frontContent}
 </Card>
 </div>
 ...
 <Card className="bg-white/90 backdrop-blur-md border border-white/30 w-full h-full flex flex-col items-start justify-center p-6 shadow-lg">
 <LucideStepBack
