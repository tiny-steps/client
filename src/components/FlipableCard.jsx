...
function FlippableCard({ frontContent, backContent }) {
  ...
  return (
    <div
      className={`relative w-full h-48 md:h-72 [perspective:1000px] ${
    ...
    >
      ...
      >
        ...
        <div className="absolute w-full h-full [backface-visibility:hidden]">
          <Card className="bg-white dark:bg-gray-800 w-full h-full flex items-center justify-center md:justify-between flex-row p-6 md:p-8">
            {frontContent}
          </Card>
        </div>
        ...
        <div className="absolute w-full h-full [backface-visibility:hidden] [transform:rotateY(180deg)]">
          <Card className="bg-white dark:bg-gray-800 w-full h-full flex flex-col items-start justify-center p-6">
            <LucideStepBack
