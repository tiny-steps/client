            ...
            <table className="w-full text-sm text-left text-gray-600 dark:text-gray-300">
                <thead className="text-xs text-gray-700 uppercase bg-white/10 backdrop-blur-sm border-b border-white/20 dark:bg-gray-700/20 dark:text-gray-400 dark:border-gray-600/30">
                    <tr>
                        ...
                        <th scope="col" className="px-4 py-2">Slots</th>
                ...
                <tbody>
                    {doctors.list.map((doc) => (
                        <tr
                            key={doc.id}
                            className="bg-white/5 backdrop-blur-sm border-b border-white/10 dark:bg-gray-800/10 dark:border-gray-700/20 hover:bg-white/10 dark:hover:bg-gray-700/20 transition-colors"
                        >
