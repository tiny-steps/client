  ...
  const frontContent = (
    <div className="flex flex-col items-center justify-center gap-3 sm:gap-4 w-full">
      ...
      <div className="text-center w-full">
        <div
          className={`font-semibold text-gray-800 mb-2 sm:mb-3 leading-tight ${
        ...
        <div className="space-y-2 sm:space-y-3">
          ...
          >
            ...
            <div className="text-left flex-1 min-w-0">
              ...
              <div
                className={`text-red-700 truncate ${
                  isMobile ? "text-xs" : "text-sm"
                }`}
              >
          ...
          {/* Add more notification options here for testing scrolling */}
          <button
            onClick={handleSendReminders}
            disabled={isLoading}
            className={`w-full flex items-center gap-2 sm:gap-3 bg-yellow-50 hover:bg-yellow-100 rounded-lg border border-yellow-200 transition-colors disabled:opacity-50 ${
              isMobile ? "p-2.5" : "p-3"
            }`}
          >
            <Mail
            ...
            <div className="text-left flex-1 min-w-0">
              <div
                className={`font-medium text-yellow-900 truncate ${
                  isMobile ? "text-sm" : "text-base"
                }`}
              >
                Email Campaigns
              ...
              >
                {isMobile ? "Marketing emails" : "Send promotional campaigns"}
              </div>
            </div>
          </button>
          ...
          <button
            onClick={handleSendReminders}
            disabled={isLoading}
            className={`w-full flex items-center gap-2 sm:gap-3 bg-indigo-50 hover:bg-indigo-100 rounded-lg border border-indigo-200 transition-colors disabled:opacity-50 ${
              isMobile ? "p-2.5" : "p-3"
            }`}
          >
            <MessageSquare
            ...
            <div className="text-left flex-1 min-w-0">
              ...
              <div
                className={`text-indigo-700 truncate ${
                  isMobile ? "text-xs" : "text-sm"
                }`}
              >
                {isMobile ? "Text messages" : "Send SMS notifications"}
              </div>
            </div>
          </button>
        </div>
