...
const BookingStatsCard = ({ bookingStats }) => {
 ...
 <tbody>
 <tr className="bg-white/5 backdrop-blur-sm border-b border-white/10 hover:bg-white/10 :bg-gray-700/20 transition-colors">
 ...
 <tr className="bg-white/5 backdrop-blur-sm hover:bg-white/10 :bg-gray-700/20 transition-colors">
