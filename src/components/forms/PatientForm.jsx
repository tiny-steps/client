...
import { useGetPatientById, useCreatePatient, useUpdatePatient } from '../../hooks/usePatientQueries.js';
...
const PatientForm = ({ mode = 'create' }) => {
  ...
  const { data: patientData, isLoading: isLoadingPatient } = useGetPatientById(id, {
    enabled: isEdit,
  });
    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-end gap-4 mt-6">
          ...
          >
            {createPatient.isPending || updatePatient.isPending ? 'Saving...' : (isEdit ? 'Update Patient' : 'Create Patient')}
          </Button>
        </div>
      </form>
      ...
      <ConfirmModal
        ...
        description={`Are you sure you want to ${isEdit ? 'update' : 'create'} this patient record?`}
