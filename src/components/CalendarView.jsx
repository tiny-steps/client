...
const CalendarView = ({ appointments }) => {
  ...
  const renderToolbar = () => (
    <div className="hidden md:flex justify-center items-center mb-6 bg-gray-100 dark:bg-gray-700 p-2 rounded-lg">
      <div className="flex space-x-2 bg-white dark:bg-gray-800 p-1 rounded-md shadow">
