...
const Applied = () => {
  ...
  const benefits = [
    {
      ...
      description: 'Enhanced verbal and non-verbal communication abilities.',
    ...
    },
    {
      ...
      description: 'Improved attention span and learning capabilities.',
    ...
    },
    {
      icon: FaUserFriends,
      title: 'Social Skills',
      description: 'Better peer interaction and social understanding.',
    ...
    },
    {
      ...
      description: 'Positive behavior reinforcement and skill development.',
  ...
  const howItWorks = [
    {
      ...
      title: 'Assessment',
      description: 'Understand strengths & needs',
    },
    {
      icon: GiAchievement,
      title: 'Personalized Plan',
      description: 'Set tailored, measurable goals',
    },
    {
      icon: FaUserFriends,
      title: '1:1 Sessions',
      description: 'Therapist-led, child-centered',
    },
    {
      icon: FaClipboardList,
      title: 'Positive Reinforcement',
      description: 'Rewards that motivate',
    },
    {
      icon: MdFamilyRestroom,
      title: 'Family Involvement',
      description: 'Coach parents for carryover',
    },
    {
      icon: FaChartLine,
      title: 'Progress Tracking',
      description: 'Review & refine regularly',
    },
  ]
  ...
  const challenges = [
    ...
    'Repetitive or Challenging Behaviors',
    'Difficulty Following Instructions',
    'Limited Play or Interaction Skills',
  ]

  const expectations = [
    'Structured sessions lasting 45–60 minutes',
    '1:1 therapist-led interaction to maintain quality of therapy',
    'Personalized behavior and skill-building plans tailored to each child',
    'Parent involvement to support learning at home',
    'Play-based & reward-driven activities for motivation and engagement',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="text-left">
                ...
                <p className="text-slate-600 text-lg leading-relaxed">
                  ...
                  tasks into smaller, manageable steps, helping children learn
                  at their own pace.
                </p>
              </div>
        ...
        >
          <div className="bg-white/70 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="relative">
                <div className="bg-gradient-to-br from-purple-100 to-pink-100 rounded-2xl p-6 shadow-lg">
                  <Puzzle className="w-24 h-24 text-purple-600 mx-auto" />
                </div>
                <p className="text-center text-gray-600 mt-4 font-medium">
                  Child engaged in structured task
                </p>
              </div>
              <div>
        ...
        >
          <div className="bg-white/70 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-3xl font-bold text-gray-800 mb-6">
                  What to Expect from an ABA Therapy Session?
                </h2>
                <div className="space-y-3">
        ...
        >
          <div className="bg-gradient-to-br from-purple-600 to-pink-600 rounded-3xl shadow-2xl p-8 text-white">
            ...
            >
              Book a consultation to begin your child's personalized ABA
              journey.
            </motion.p>
