...
const Aqua = () => {
  ...
  const benefits = [
    ...
    'Provides safe environment for movement',
  ]

  const challenges = [
    'Poor balance and coordination',
    'Muscle weakness or low muscle tone',
    'Fear of movement or physical activities',
    'Sensory processing difficulties',
    'Mobility or movement restrictions',
    'Need for gentle, supportive exercise environment',
  ]

  const expectations = [
    'Water-based therapy sessions in heated pool',
    "Gentle exercises designed for each child's needs",
    'Supportive environment that reduces physical strain',
    'Focus on movement, balance, and coordination',
    'Sensory integration through water therapy',
    'Trained aqua therapists for safety and guidance',
    'Fun, engaging activities that feel like play',
  ]

  const whoCanBenefit = [
    'Children with physical disabilities or mobility challenges',
    'Kids with low muscle tone or strength issues',
    'Children with sensory processing disorders',
    'Kids who benefit from gentle, supportive exercise',
    'Any child who needs movement therapy in a safe environment',
  ]
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-indigo-100 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="text-left">
                ...
                <p className="text-slate-600 text-lg leading-relaxed">
                  ...
                  resistance of water create a safe and supportive environment
                  for children to build skills, increase confidence, and enjoy
                  movement in a therapeutic way.
                </p>
              </div>
              <div className="relative">
                <div className="bg-gradient-to-br from-cyan-100 to-blue-100 rounded-2xl p-6 shadow-lg">
                  <Waves className="w-24 h-24 text-cyan-600 mx-auto" />
                </div>
              </div>
            </div>
          </motion.div>
        ...
        >
          ...
          <div className="bg-white/70 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="relative">
                <div className="bg-gradient-to-br from-cyan-100 to-blue-100 rounded-2xl p-6 shadow-lg">
                  <Droplets className="w-24 h-24 text-cyan-600 mx-auto" />
                </div>
                <p className="text-center text-gray-600 mt-4 font-medium">
                  Gentle movement in supportive water environment
                </p>
              </div>
              <div>
        ...
        <motion.div
          ...
          className="mb-20"
        >
          <div className="bg-gradient-to-br from-cyan-100 to-blue-100 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-8">
            <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
              Who Can Benefit?
            </h2>
            <div className="space-y-4 max-w-3xl mx-auto">
              ...
              >
                <p className="text-gray-800 font-medium text-center">
                  ...
                  environment for children to develop physical strength,
                  coordination, and confidence through water-based exercises.
                </p>
              </motion.div>
            </div>
          </div>
        ...
        >
          <div className="bg-gradient-to-br from-cyan-600 to-blue-600 rounded-3xl shadow-2xl p-8 text-white">
            <motion.h2
              initial={{ opacity: 0, y: 20 }}
              animate={
            ...
            >
              Book a consultation to begin your child's personalized Aqua
              Therapy journey.
            </motion.p>
            ...
            >
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="bg-white text-cyan-600 px-8 py-4 rounded-xl font-semibold hover:bg-gray-100 transition-all duration-300 flex items-center gap-2 shadow-lg hover:shadow-xl transform hover:scale-105"
              >
