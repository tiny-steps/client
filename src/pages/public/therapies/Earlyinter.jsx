...
const Earlyinter = () => {
  ...
  const benefits = [
    {
      ...
      description: 'Identifies developmental delays or concerns promptly.',
    ...
    },
    {
      ...
      description: "Customized plans addressing each child's unique needs.",
    ...
    },
    {
      ...
      description:
        'Empowers parents with tools and guidance to support progress.',
    ...
    },
    {
      ...
      description: 'Enhances long-term development and learning potential.',
  ...
  const howItWorks = [
    {
      ...
      description:
        'Assessment by specialists to understand developmental status.',
    },
    {
      icon: FaClipboardList,
      title: 'Individualized Plan',
      description: 'Goals tailored to support specific growth areas.',
    },
    {
      icon: FaUserMd,
    ...
    },
    {
      ...
      description: 'Ongoing progress checks and updates',
    },
    {
      icon: FaMedal,
      title: 'Family Training',
      description: 'Guidance for parents to reinforce skills at home',
    },
  ]
  ...
  const expectations = [
    ...
    'Therapy tailored to developmental needs',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-purple-100 to-pink-100 rounded-2xl p-6 shadow-lg">
                  <Sprout className="w-24 h-24 text-purple-600 mx-auto" />
                </div>
              </div>
            </div>
          </motion.div>
        ...
        >
          <div className="bg-white/70 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="relative">
                <div className="bg-gradient-to-br from-purple-100 to-pink-100 rounded-2xl p-6 shadow-lg">
                  <Baby className="w-24 h-24 text-purple-600 mx-auto" />
                </div>
                <p className="text-center text-gray-600 mt-4 font-medium">
                  Therapist guiding a young child
                </p>
              </div>
              <div>
                <h2 className="text-3xl font-bold text-gray-800 mb-6">
                  Challenges It Helps Identify
                </h2>
        ...
        >
          <div className="bg-gradient-to-br from-purple-600 to-pink-600 rounded-3xl shadow-2xl p-8 text-white">
            ...
            >
              Enroll in the Early Intervention Program at Tiny Steps Clinic and
              give your child a strong foundation for growth and success.
            </motion.p>
