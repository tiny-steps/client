...
const ASDScreening = () => {
  ...
  const benefits = [
    {
      ...
      description:
        'Spot signs of autism before school age for better outcomes.',
    ...
    },
    {
      ...
      description: 'Provides direction for further evaluation or therapy.',
    ...
    },
    {
      ...
      description: 'Supports ongoing monitoring even without a diagnosis.',
    ...
    {
      icon: FaStopwatch,
      title: 'Faster Access to Support',
      description: 'Reduces wait time by flagging needs early.',
  ...
  const howItWorks = [
    {
      ...
      description: "Understand child's behavior, development & communication",
    },
    {
      icon: FaUsers,
      title: 'Parent Interviews',
      description: 'Gather developmental history & concerns',
    },
    {
      icon: FaFileAlt,
      title: 'Standardized Tools',
      description: 'Use questionnaires & checklists to assess behaviors',
    },
    {
      icon: FaEye,
      title: 'Observation',
      description: 'Watch how the child interacts & communicates',
    },
    {
      icon: FaChartLine,
      title: 'Progress Tracking',
      description: 'Receive regular updates & future planning steps',
    },
  ]
  ...
  const challenges = [
    ...
    'Challenges in Social, Communication, or Cognitive Skills',
  ]

  const expectations = [
    '45–90 minute session duration',
    'Developmental history & caregiver interviews',
    'Child observation in natural, interactive settings',
    'Use of standardized questionnaires & tools',
    'Screening report with insights & professional feedback',
    'Recommendations for therapy or further evaluation',
    'Family-centered, supportive guidance',
  ]
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="text-left">
                ...
                <p className="text-slate-600 text-lg leading-relaxed">
                  ASD Screening is an early identification process to detect
                  signs of autism spectrum disorder in children. It helps
                  families and professionals understand developmental challenges
                  and ensures timely intervention for communication, social, and
                  behavioral needs.
                </p>
              </div>
              <div className="relative">
                <div className="bg-gradient-to-br from-purple-100 to-pink-100 rounded-2xl p-6 shadow-lg">
                  <FileSearch className="w-24 h-24 text-purple-600 mx-auto" />
                </div>
              </div>
            </div>
          </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="relative">
                ...
                <p className="text-center text-gray-600 mt-4 font-medium">
                  Child in ASD screening activity
                </p>
              </div>
              <div>
        ...
        >
          <div className="bg-white/70 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-3xl font-bold text-gray-800 mb-6">
                  What to Expect from an ASD Screening Session?
                </h2>
                <div className="space-y-3">
            ...
            <div className="space-y-4 max-w-3xl mx-auto">
              ...
              >
                <p className="text-gray-800 font-medium text-center">
                  💡 At Tiny Steps, ASD Screening empowers families with
                  clarity, timely action, and hope for their child's future.
                </p>
              </motion.div>
            </div>
          </div>
        ...
        >
          <div className="bg-gradient-to-br from-purple-600 to-pink-600 rounded-3xl shadow-2xl p-8 text-white">
            ...
            >
              Start Your Child's Developmental Journey
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={
            ...
            >
              Book an ASD Screening session at Tiny Steps Clinic today.
            </motion.p>
