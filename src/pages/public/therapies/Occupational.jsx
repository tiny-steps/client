...
const Occupational = () => {
  ...
  const benefits = [
    {
      icon: FaHandPaper,
      title: 'Enhances Fine & Gross Motor Skills',
      description: 'Improved hand-eye coordination and movement control.',
      color: 'from-blue-400 to-blue-600',
      bgColor: 'from-blue-50 to-blue-100',
    },
    {
      icon: FaCrosshairs,
      title: 'Improves Focus, Attention & Learning',
      description: 'Better concentration and academic performance.',
      color: 'from-green-400 to-green-600',
      bgColor: 'from-green-50 to-green-100',
    },
    {
      icon: FaLock,
      title: 'Supports Independence in Daily Living',
      description: 'Self-care skills and daily task completion.',
      color: 'from-orange-400 to-orange-600',
      bgColor: 'from-orange-50 to-orange-100',
    },
    {
      icon: FaRegClock,
      title: 'Strengthens Coordination & Motor Planning',
      description: 'Better movement organization and execution.',
      color: 'from-pink-400 to-pink-600',
      bgColor: 'from-pink-50 to-pink-100',
    },
    {
      icon: FaBolt,
      title: 'Builds Confidence in School & Social',
      description: 'Increased self-esteem and peer interaction.',
      color: 'from-purple-400 to-purple-600',
      bgColor: 'from-purple-50 to-purple-100',
    },
    {
      icon: FaSlidersH,
      title: 'Helps with Sensory Processing',
      description: 'Better sensory regulation and responses.',
  ...
  const howItWorks = [
    {
      ...
      title: 'Assessment',
      description: 'Evaluate abilities & needs',
    },
    {
      icon: FaBullseye,
      title: 'Individualized Goals',
      description: 'Set daily activity plans.',
    },
    {
      icon: FaPlay,
      title: 'Play-Based Exercises',
      description: 'Functional activities for skill-building.',
    },
    {
      icon: FaPen,
      title: 'Handwriting & Self-Care',
      description: 'Improve essential skills.',
    },
    {
      icon: FaLayerGroup,
      title: 'Sensory Integration',
      description: 'Regulation through sensory play.',
    },
    {
      icon: FaChartBar,
      title: 'Progress Tracking',
      description: 'Regular parent feedback.',
    },
  ]

  const challenges = [
    'Difficulty with Writing, Drawing, or Hand Skills',
    'Struggles with Dressing, Eating, or Self-Care Tasks',
    'Poor Balance, Coordination, or Posture',
    'Sensory Processing Issues (over/under sensitivity)',
    'Low Confidence in School or Play Activities',
    'Trouble with Focus, Attention, or Task Completion',
  ]

  const expectations = [
    '45–60 minute tailored sessions Fun, engaging, and play-based',
    'activities Exercises supporting independence Motor skill games,',
    'crafts, and movement Sensory activities for regulation and focus',
    'Therapist guidance and home strategies A supportive and',
    'confidence-boosting experience',
  ]

  const whoCanBenefit = [
    'Children with autism, ADHD, or developmental delays',
    'Kids with sensory processing challenges',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="text-left">
                ...
                <p className="text-slate-600 text-lg leading-relaxed">
                  Occupational Therapy (OT) helps children develop the skills
                  they need for daily living, learning, and playing. It focuses
                  on improving fine motor skills, sensory processing,
                  coordination, and independence. Through engaging activities
                  and structured support, OT empowers children to gain
                  confidence in everyday tasks.
                </p>
              </div>
              <div className="relative">
                <div className="bg-gradient-to-br from-purple-100 to-pink-100 rounded-2xl p-6 shadow-lg">
                  <Settings className="w-24 h-24 text-purple-600 mx-auto" />
                </div>
              </div>
            </div>
          </motion.div>
        ...
        >
          <div className="bg-white/70 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="relative">
                <div className="bg-gradient-to-br from-purple-100 to-pink-100 rounded-2xl p-6 shadow-lg">
                  <Hand className="w-24 h-24 text-purple-600 mx-auto" />
                </div>
                <p className="text-center text-gray-600 mt-4 font-medium">
                  Child engaged in OT activities
                </p>
              </div>
              <div>
        ...
        >
          <div className="bg-gradient-to-br from-purple-600 to-pink-600 rounded-3xl shadow-2xl p-8 text-white">
            ...
            >
              Support Your Child's Growth with OT
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={
            ...
            >
              Book a session today at Tiny Steps Clinic and help your child
              thrive.
            </motion.p>
