...
const Development = () => {
  ...
  const benefits = [
    {
      ...
      description: 'Detects delays before they impact learning or behavior.',
    ...
    },
    {
      ...
      description: "Tracks your child's progress across key milestones.",
    ...
    },
    {
      ...
      description: 'Allows for earlier support that can improve outcomes.',
    ...
    },
    {
      ...
      description:
        'Provides parents with resources and confidence to advocate for their child.',
  ...
  const howItWorks = [
    ...
    },
    {
      icon: FaSearch,
      title: 'Observation',
      description: 'Optional child observation for additional insights',
    },
    {
      icon: FaUsers,
      title: 'Discussion with Parents',
      description: 'Review results and next steps with a specialist',
    },
    {
      icon: FaLink,
      title: 'Referral (if needed)',
      description: 'Recommendations for further evaluation or intervention',
    },
  ]

  const challenges = [
    'Speech and language delays',
    'Social interaction or emotional issues',
    'Fine and gross motor difficulties',
    'Cognitive delays in problem-solving',
    'Lack of milestone achievement',
    'Behavioral concerns flagged by parents or caregivers',
  ]

  const expectations = [
    '30–60 minute session',
    'Parent-completed questionnaires (ASQ, M-CHAT)',
    'Optional observation or play-based screening',
    'Quick results summary with guidance',
    'Referrals or support if concerns are flagged',
    'Peace of mind when development is on track',
  ]

  const whoCanBenefit = [
    'Children aged 6 months to 5 years',
    'Parents seeking peace of mind',
    'Kids not meeting typical milestones',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="text-left">
                ...
                <p className="text-slate-600 text-lg leading-relaxed">
                  ...
                  monitor your child's growth in key areas like communication,
                  motor skills, problem-solving, and social interaction. It
                  helps identify children who may need further evaluation or
                  early intervention support.
                </p>
              </div>
              <div className="relative">
                <div className="bg-gradient-to-br from-purple-100 to-pink-100 rounded-2xl p-6 shadow-lg">
                  <Clipboard className="w-24 h-24 text-purple-600 mx-auto" />
                </div>
              </div>
            </div>
          </motion.div>
        ...
        >
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">
              <span className="bg-gradient-to-r from-purple-700 via-pink-600 to-indigo-700 bg-clip-text text-transparent">
                How Developmental Screening Works
              </span>
            </h2>
          </div>
        ...
        >
          <div className="bg-white/70 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="relative">
                <div className="bg-gradient-to-br from-purple-100 to-pink-100 rounded-2xl p-6 shadow-lg">
                  <TrendingUp className="w-24 h-24 text-purple-600 mx-auto" />
                </div>
                <p className="text-center text-gray-600 mt-4 font-medium">
                  Child during developmental check
                </p>
              </div>
              <div>
        ...
        >
          <div className="bg-white/70 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-3xl font-bold text-gray-800 mb-6">
                  What to Expect from a Screening Session?
                </h2>
                <div className="space-y-3">
            ...
            <div className="space-y-4 max-w-3xl mx-auto">
              ...
              >
                <p className="text-gray-800 font-medium text-center">
                  💡 Developmental screening empowers families with early
                  knowledge to give children their best start in life.
                </p>
              </motion.div>
            </div>
          </div>
