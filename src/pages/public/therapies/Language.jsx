...
const Language = () => {
  ...
  const benefits = [
    {
      icon: BookIcon,
      title: 'Improves Understanding & Concepts',
      description: 'Enhanced comprehension and conceptual learning.',
      color: 'from-blue-400 to-blue-600',
      bgColor: 'from-blue-50 to-blue-100',
    },
    {
      icon: TypeIcon,
      title: 'Builds Vocabulary & Sentences',
      description: 'Expanded word knowledge and sentence construction.',
      color: 'from-green-400 to-green-600',
      bgColor: 'from-green-50 to-green-100',
    },
    {
      icon: BookOpenIcon,
      title: 'Strengthens Storytelling Skills',
      description: 'Better narrative and communication abilities.',
      color: 'from-orange-400 to-orange-600',
      bgColor: 'from-orange-50 to-orange-100',
    },
    {
      icon: PenToolIcon,
      title: 'Enhances Reading & Writing Readiness',
      description: 'Preparation for academic success.',
      color: 'from-pink-400 to-pink-600',
      bgColor: 'from-pink-50 to-pink-100',
    },
    {
      icon: ZapIcon,
      title: 'Boosts Confidence in Communication',
      description: 'Increased self-esteem in expressing ideas.',
  ...
  const howItWorks = [
    {
      ...
      description: 'Evaluate comprehension & expression abilities',
    },
    {
      icon: ClipboardCheck,
      title: 'Individualized Goals',
      description: 'Set targeted language development plans',
    },
    {
      icon: UsersIcon,
      title: 'Interactive Activities',
      description: 'Games, books, and conversations',
    },
    {
      icon: Image,
      title: 'Visual & Verbal Practice',
      description: 'Pictures, stories, and role-play',
    },
    {
      icon: RefreshCcw,
      title: 'Repetition & Reinforcement',
      description: 'Practice for skill retention',
    },
    {
      icon: BarChart2,
      title: 'Progress Monitoring',
      description: 'Track language development regularly',
    },
  ]
  ...
  const challenges = [
    ...
    'Challenges with grammar, sentence structure',
    'Problems with storytelling or describing events',
    'Struggles with reading comprehension or pre-literacy skills',
  ]

  const expectations = [
    '45–60 minute interactive sessions tailored to the child',
    'Engaging activities with books, pictures, and language games',
    'Focus on receptive and expressive language skills',
    'Practice with vocabulary, grammar, and sentence building',
    'Storytelling and conversational activities',
    'Parent guidance for language support at home',
    'Fun, supportive environment for language growth',
  ]

  const whoCanBenefit = [
    'Children with language delays or disorders',
    'Kids with autism, developmental delays, or speech challenges',
    'Children struggling with reading or pre-literacy skills',
    'Kids who need support expressing thoughts or understanding others',
    'Any child who would benefit from stronger language and communication skills',
  ]
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="text-left">
                ...
                <p className="text-slate-600 text-lg leading-relaxed">
                  ...
                  language (understanding what others say) and expressive
                  language (using words, sentences, and communication). The goal
                  is to help children express themselves clearly, build
                  vocabulary, and improve overall communication.
                </p>
              </div>
              <div className="relative">
                <div className="bg-gradient-to-br from-purple-100 to-pink-100 rounded-2xl p-6 shadow-lg">
                  <Book className="w-24 h-24 text-purple-600 mx-auto" />
                </div>
              </div>
            </div>
          </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="relative">
                ...
                <p className="text-center text-gray-600 mt-4 font-medium">
                  Building language skills step by step
                </p>
              </div>
              <div>
        ...
        >
          <div className="bg-white/70 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-3xl font-bold text-gray-800 mb-6">
                  What to Expect from a Language Therapy Session?
                </h2>
                <div className="space-y-3">
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-blue-100 to-indigo-100 rounded-2xl p-6 shadow-lg">
                  <Type className="w-24 h-24 text-blue-600 mx-auto" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4 max-w-3xl mx-auto">
              ...
              >
                <p className="text-gray-800 font-medium text-center">
                  At Tiny Steps, Language Therapy helps children build strong
                  communication foundations, express themselves with confidence,
