  ...
  const benefits = [
    {
      ...
      description:
        'Learn to interact positively with peers and build friendships.',
    ...
    },
    {
      ...
      description: 'Practice conversational skills and group interactions.',
    ...
    },
    {
      ...
      description:
        'Develop self-esteem through peer support and shared experiences.',
      color: 'from-orange-400 to-orange-600',
      bgColor: 'from-orange-50 to-orange-100',
    },
    {
      icon: FaSmileBeam,
      title: 'Encourages Empathy',
      description: "Learn to understand and respond to others' emotions.",
      color: 'from-yellow-400 to-yellow-600',
      bgColor: 'from-yellow-50 to-yellow-100',
    },
    {
      icon: FaShareAlt,
      title: 'Develops Cooperation',
      description: 'Practice sharing, turn-taking, and teamwork skills.',
  ...
  const howItWorks = [
    {
      ...
      description: 'Evaluate social and communication needs',
    },
    {
      icon: FaUserFriends,
      title: 'Peer Matching',
      description: 'Group children with similar goals and abilities',
    },
    {
      icon: FaPlay,
      title: 'Structured Activities',
      description: 'Games, role-play, and interactive exercises',
    },
    {
      icon: FaShareAlt,
      title: 'Social Practice',
      description: 'Real-time peer interaction and feedback',
    },
    {
      icon: FaThumbsUp,
      title: 'Positive Reinforcement',
      description: 'Celebrate social successes and progress',
    },
    {
      icon: FaChartBar,
      title: 'Group Progress Tracking',
      description: 'Monitor social skill development regularly',
    },
  ]

  const challenges = [
    'Difficulty making friends or connecting with peers',
    'Challenges with sharing, turn-taking, or cooperation',
    'Struggles with group conversations or social cues',
    'Low confidence in social situations',
    "Problems with empathy or understanding others' feelings",
    'Difficulty following group rules or instructions',
  ]

  const expectations = [
    '45–60 minute group sessions with 3-5 children',
    'Age and skill-appropriate peer groups',
    'Structured activities that promote social interaction',
    'Guided practice with real peer feedback',
    'Focus on communication, cooperation, and friendship skills',
    'Therapist facilitation and positive reinforcement',
    'Fun, supportive environment for social growth',
  ]

  const whoCanBenefit = [
    'Children with autism spectrum disorder or social communication challenges',
    'Kids who are shy, withdrawn, or have difficulty making friends',
    'Children with ADHD who struggle with social skills',
    'Kids who need practice with peer interaction and group dynamics',
    'Any child who would benefit from supported social skill development',
  ]
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
        ...
        >
          <div className="bg-white/70 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="relative">
                <div className="bg-gradient-to-br from-purple-100 to-pink-100 rounded-2xl p-6 shadow-lg">
                  <UserPlus className="w-24 h-24 text-purple-600 mx-auto" />
                </div>
                <p className="text-center text-gray-600 mt-4 font-medium">
                  Building social connections together
                </p>
              </div>
              <div>
            ...
            <div className="space-y-4 max-w-3xl mx-auto">
              ...
              >
                <p className="text-gray-800 font-medium text-center">
                  At Tiny Steps, Group Therapy creates a supportive community
                  where children learn together, grow together, and build
                  lasting social skills and friendships.
                </p>
              </motion.div>
            </div>
          </div>
        ...
        >
          <div className="bg-gradient-to-br from-purple-600 to-pink-600 rounded-3xl shadow-2xl p-8 text-white">
            ...
            >
              Book a consultation to begin your child's personalized Group
              Therapy journey.
            </motion.p>
