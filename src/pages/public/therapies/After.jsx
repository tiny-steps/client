...
const After = () => {
  ...
  const benefits = [
    {
      ...
      description: 'Help with homework and skill-building.',
    ...
    },
    {
      ...
      description: 'Foster friendships and teamwork.',
    ...
    },
    {
      ...
      description: 'Explore art, music, and games.',
    ...
    },
    {
      ...
      description: 'Promote health and fitness through play.',
    ...
    },
    {
      ...
      description: 'Flexible hours to support busy families.',
  ...
  const howItWorks = [
    {
      ...
      description: 'Families sign up and get an overview.',
    },
    {
      icon: FaCalendarAlt,
      title: 'Daily Schedule',
      description:
        'Structured mix of homework time, activities, and free play.',
    },
    {
      icon: FaChalkboardTeacher,
      title: 'Supervised Support',
      description: 'Trained staff guide and assist students.',
    },
    {
      icon: FaChartLine,
      title: 'Progress Tracking',
      description: 'Regular updates on academic & social growth.',
    },
    {
      icon: FaStar,
      title: 'Special Events',
      description: 'Exciting field trips, celebrations & showcases.',
    },
  ]

  const challenges = [
    'Difficulty staying focused after school',
    'Social skill development gaps',
  ...
  const whoCanBenefit = [
    ...
    'Kids wanting teamwork & social growth',
    'Students who thrive in small groups',
    'Families seeking safe after-school care',
  ]
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-purple-100 to-pink-100 rounded-2xl p-6 shadow-lg">
                  <Backpack className="w-24 h-24 text-purple-600 mx-auto" />
                </div>
              </div>
            </div>
          </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="relative">
                ...
                <p className="text-center text-gray-600 mt-4 font-medium">
                  Child enjoying structured activities
                </p>
              </div>
              <div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-blue-100 to-indigo-100 rounded-2xl p-6 shadow-lg">
                  <Calendar className="w-24 h-24 text-blue-600 mx-auto" />
                </div>
              </div>
            </div>
          </div>
