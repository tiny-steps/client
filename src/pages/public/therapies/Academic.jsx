...
const Academic = () => {
  ...
  const benefits = [
    {
      ...
      description: 'Identifies specific learning gaps and academic strengths.',
    ...
    },
    {
      ...
      description: "Customized curriculum tailored to each child's needs.",
    ...
    },
    {
      ...
      description: 'Regular tracking and adjustment of learning goals.',
    ...
    },
    {
      ...
      description: 'Helps children regain confidence and joy in learning.',
    ...
    },
    {
      ...
      description: 'Rapid improvement in fundamental academic abilities.',
  ...
  const howItWorks = [
    {
      ...
      description:
        'Identifies strengths and areas needing support in reading, writing, and math.',
    },
    {
      icon: FaBookOpen,
      title: 'Individualized Plan',
      description: 'Personalized academic goals based on assessment results.',
    },
    {
      icon: FaChalkboardTeacher,
      title: '1:1 or Small Group',
      description: 'Hands-on, interactive sessions with a learning specialist.',
    },
    {
      icon: FaRegChartBar,
  ...
  const skillsTargeted = [
    ...
    'Basic math operations & problem-solving',
  ...
  const expectations = [
    'Weekly sessions (30–60 minutes each)',
    'Structured, skill-building curriculum',
    'Supportive & engaging teaching style',
    'Regular parent feedback & progress updates',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="text-left">
                <h2 className="text-3xl font-bold text-gray-800 mb-4">
                  What is the Academic Skill Deficit Program?
                </h2>
                <p className="text-slate-600 text-lg leading-relaxed">
                  The Academic Skill Deficit Program is designed to support
                  children who struggle with core learning areas like reading,
                  writing, and math. Our evidence-based, individualized approach
                  builds foundational academic skills and confidence, helping
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div>
                ...
                <div className="space-y-3">
                  {skillsTargeted.map((skill, index) => (
                    <motion.div
                      key={index}
            ...
            <div className="space-y-4 max-w-3xl mx-auto">
              ...
              >
                <p className="text-gray-800 font-medium text-center">
                  With the right support, every child can rediscover the joy of
                  learning.
                </p>
              </motion.div>
            </div>
        ...
        >
          <div className="bg-gradient-to-br from-purple-600 to-pink-600 rounded-3xl shadow-2xl p-8 text-white">
            ...
            >
              Enroll in the Academic Skill Deficit Program at Tiny Steps Clinic
              and empower your child with the tools to succeed.
            </motion.p>
